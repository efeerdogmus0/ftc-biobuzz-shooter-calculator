...
The Coulomb cap supports sliding and the effective-mass clamp supports sticking. Unknown wheel inertia is an ideal-speed boundary: inverse inertia is zero and no measured inertia-dependent metric is claimed. A passive hood has zero surface speed. All configured additional rollers are simultaneous lumped contacts, not spatially sequenced engagements. Contact terminates at traveled hood arc length or the configurable contact time limit; an incomplete transit is warned.
